...
export function GridCell({ children, colSpan, rowSpan, className, ...props }: GridItemProps) {
  ...
  return (
    <div
      className={cn(colSpanClass, rowSpanClass, 'border-0 border-gray-200 p-6 xs:p-12', className)}
      {...props}
    >
      {children}
    </div>
