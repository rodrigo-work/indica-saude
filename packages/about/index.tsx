...
export const LogoIndicaSaude: React.FC<HeadingProps> = () => (
  <div className="flex flex-row items-center gap-1">
    <Icon className="size-7" />
    <div className="flex flex-col">
      <span className="font-semibold text-sm tracking-tight leading-none--">Indica Saúde</span>
      <span className="text-xs text-muted-foreground">{`Application Referral`}</span>
    </div>
  </div>
)
