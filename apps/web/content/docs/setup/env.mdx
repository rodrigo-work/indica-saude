...
descriptions: How to configure environment variables in **Indica Saúde**.
---

**Indica Saúde** uses environment variables for configuration. This guide will help you set up the required variables to get started quickly, and optionally configure additional features.

## Quick Start (Minimum Setup)

To get **Indica Saúde** running locally with basic functionality, you only need to configure these **required** variables:
...
<Steps>
  <Step>
    Fork the [**Indica Saúde** template](https://basehub.com/basehub/**Indica Saúde**?fork=1) on BaseHub
  </Step>
...
**Indica Saúde** uses environment variables across multiple locations:
