...
export const MenuLinkItem = ({ item, ...props }: { item: LinkItemType; className?: string }) => {
  if (item.type === 'custom')
...
export const MenuContent = (props: ComponentPropsWithoutRef<typeof NavigationMenuContent>) => {
  return (
