...
export const GET = async (_req: Request, { params }: { params: Promise<{ slug: string[] }> }) => {
  ...
  const geistBold = await readFile(join(__dirname, 'Geist-Bold.ttf'))
  const geistRegular = await readFile(join(__dirname, 'Geist-Regular.ttf'))
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage:
          'radial-gradient(circle at 25px 25px, lightgreen 2%, transparent 0%), radial-gradient(circle at 75px 75px, lightgreen 2%, transparent 0%)',
    ...
    >
      ...
      >
        ...
        <img alt="Logo" height={160} src={logoSrc} style={{ margin: '0 0px' }} width={360} />
        {/* <Logo /> */}
...
const _IvonIs = () => {
  return (
    <span>
      ...
      <div className="-gap-0.9 flex flex-col leading-none">
