...
const Angular = (props: ComponentProps<'svg'>) => (
  <svg fill="none" viewBox="0 0 188 200" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Angular</title>
    <path d="m94 0-93.099976 33.2 14.199976 123.1 78.9 43.7 78.9-43.7 14.2-123.1z" fill="#dd0031" />
...
const Astro = (props: ComponentProps<'svg'>) => (
  <svg fill="none" viewBox="0 0 85 107" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Astro</title>
    <path
...
const Qwik = (props: ComponentProps<'svg'>) => (
  <svg fill="none" viewBox="0 0 154 165" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Qwik</title>
    <path
...
const Remix = (props: ComponentProps<'svg'>) => (
  <svg fill="none" viewBox="0 0 411 473" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Remix</title>
    <g fill="currentColor">
      <path
        clipRule="evenodd"
...
const Solid = (props: ComponentProps<'svg'>) => (
  <svg viewBox="0 0 166 155.3" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Solid</title>
    <defs>
      <linearGradient gradientUnits="userSpaceOnUse" id="a" x1="27.5" x2="152" y1="3" y2="63.5">
        <stop offset=".1" stopColor="#76b3e1" />
        <stop offset=".3" stopColor="#dcf2fd" />
        <stop offset="1" stopColor="#76b3e1" />
      </linearGradient>
      <linearGradient gradientUnits="userSpaceOnUse" id="b" x1="95.8" x2="74" y1="32.6" y2="105.2">
...
const Vue = (props: ComponentProps<'svg'>) => (
  <svg viewBox="0 0 261.76 226.69" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Vue</title>
...
export const ZeroConfig = async () => (
  <div className="grid gap-8">
    <div className="mx-auto grid max-w-2xl gap-4 text-center">
      <h2 className="font-semibold text-3xl tracking-tight sm:text-4xl">Zero-config by design</h2>
    ...
    >
      <TabsList className="w-full rounded-none bg-transparent">
        {configs.map((config) => (
          <TabsTrigger className="flex-auto p-0" key={config.label} value={config.label}>
