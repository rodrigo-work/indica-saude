...
export const FEATURES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        caption: 'This toolchain is unopinionated, so you need to configure every rule and setting.'
      },
      {
      ...
      },
      {
        ...
        icon: MinusIcon,
        color: 'text-muted-foreground',
        caption: 'ESLint is built in JavaScript and can struggle with large codebases.'
      },
      {
        text: 'Setup in minutes',
        icon: MinusIcon,
        color: 'text-muted-foreground',
        caption: 'ESLint is a complex toolchain that requires a lot of configuration.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        icon: MinusIcon,
        color: 'text-muted-foreground',
        caption: 'Biome comes with hundreds of rules you can enable and configure.'
      },
      {
      ...
      },
      {
        ...
        icon: CheckIcon,
        color: 'text-emerald-500',
        caption: 'Ultracite uses Biome, which is built in Rust and is lightning fast.'
      },
      {
        text: 'Agent Rules',
        icon: CheckIcon,
      ...
      },
      {
        ...
        icon: CheckIcon,
        color: 'text-emerald-500',
        caption: 'You can setup and configure Ultracite in seconds with the `init` command.'
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: MinusIcon,
        color: 'text-muted-foreground',
        caption: 'Biome is unopinionated, so you need to configure every rule and setting.'
      },
      {
        text: '1 dependency',
        icon: CheckIcon,
